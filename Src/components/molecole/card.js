...
if(props.data){
    ...
    return(
        <View style={style.container}>
            ...
            <ButtonComp color='red' title='Rimuovi' onPress={()=>props.removeItem(props.id)}/>
            <ButtonComp color='yellow' title='Dettagli' onPress={()=>props.navigation.navigate('Dettagli',{id:props.id})}/>
            </View>
